...
//       const retweet = (bot, originalMessage, message, submitPrompt) => {
//         helpers.is_admin(bot, message, (err) => {
//           if (err) {
//             bot.api.chat.postEphemeral({
...
//             });
//           } else {
//             // console.log('retweet', originalMessage.actions[0].value);
//             twitter.retweet(originalMessage.actions[0].value, (err) => {
//               if (err) {
...
//                   twitter.prompt_submit(null, originalMessage.actions[0].value);
//                 }
//                 bot.api.chat.postMessage({
//                   channel: originalMessage.channel,
//                   text: `<@${originalMessage.user}> Retweeted :thumbsup:`,
//                 });
//               }
//             });
//           }
...
//       if (originalMessage.actions[0].name === "retweet") {
//         retweet(bot, originalMessage, message, false);
//       } else if (originalMessage.actions[0].name === "retweet_submit") {
//         retweet(bot, originalMessage, message, true);
//       }
